...
RAW_FILE = os.path.join(OPEC_DIR, "opec_texts_raw.csv")
OUT_FILE = os.path.join(OPEC_DIR, "opec_texts_clean_sections.csv")

# --- 1. Cleaning ---
def clean_text(text: str) -> str:
    """Remove headers, page numbers, multiple spaces, etc."""
...
# --- 2. Section splitting ---
# typical OPEC section titles (add more if needed)
SECTION_HEADERS = [
    "World Oil Demand",
    "World Oil Supply",
    "Non-OPEC Supply",
...
def split_into_sections(text: str):
    ...
    sections = {}
    # escape parentheses and special chars for regex
