...
OUT_FILE = os.path.join(OPEC_DIR, "opec_features_finbert_chunked.csv")
...
def finbert_sentiment_chunked(text):
    """Compute average sentiment across smaller chunks (3–5 sentences each)."""
...
def main():
    ...
    for _, row in tqdm(df.iterrows(), total=len(df)):
        ...
        # Sentiment (average of small chunks)
