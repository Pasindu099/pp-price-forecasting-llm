...
# -------- CONFIG --------
DATA_DIR = r"C:\Users\wpmpo\OneDrive\Documents\DSSB - SEM 3\Digital Transformation\commodity_analysis 1\data\reports\energy\opec"
IN_FILE = os.path.join(DATA_DIR, "opec_texts_clean_sections.csv")
OUT_FILE = os.path.join(DATA_DIR, "opec_comparison_scores_gpt.csv")
